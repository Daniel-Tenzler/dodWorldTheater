...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.15,	-- how fast pops are Hired when there is a high demand (was 0.2 - slower hiring to reduce oversupply)
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.03,	-- how fast pops are Hired when there is a medium demand (was 0.02 - slower medium hiring to reduce oversupply)
	RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.25,		-- how fast pops are Fired when there is a low demand (was 0.2 - faster firing to reduce oversupply)
